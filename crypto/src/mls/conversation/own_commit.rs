...
mod tests {
    ...
    async fn should_succeed_when_incoming_commit_is_self_commit_but_was_lost(case: TestContext) {
        ...
        // ok, alice is back, and look: here's that commit that the made
        alice
            .transaction
            .conversation(&conversation_id)
            .await
        ...
        // couldn't figure out how to make it work given the OpenMLS primitives available. Ref: [WPB-14764].
        return;

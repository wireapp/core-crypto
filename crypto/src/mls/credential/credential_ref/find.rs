...
use core_crypto_keystore::entities::CredentialFindFilters as KeystoreFindFilters;
...
use crate::mls::session::id::ClientIdRef;
...
impl CredentialRef {
    ...
    pub async fn find(database: &impl FetchFromDatabase, find_filters: FindFilters<'_>) -> Result<Vec<Self>> {
        let FindFilters {
            client_id,
            cipher_suite,
            credential_type,

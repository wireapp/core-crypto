import { inMemoryDatabase } from "../../src/autogenerated/core-crypto-ffi";
import {
    Ciphersuite,
    type CommitBundle,
    type ConversationId,
 ...
 */
export async function ccInit(clientName: string): Promise<CcWithDatabase> {

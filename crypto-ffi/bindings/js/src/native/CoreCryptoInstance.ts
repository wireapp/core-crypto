...
import { PkiEnvironment } from "./PkiEnvironment";
...
export class CoreCrypto extends CoreCryptoFfi {
     ...
     */
    async setPkiEnvironment(
        pkiEnvironment: PkiEnvironment | undefined
    ): Promise<void> {
        await super.setPkiEnvironment(pkiEnvironment);
    }
     ...
     */
    async getPkiEnvironment(): Promise<PkiEnvironment | undefined> {
        const instance = await super.getPkiEnvironment();

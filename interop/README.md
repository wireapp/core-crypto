...
Install a chromium browser, e.g., google chrome:
...
- `crypto-ffi/bindings/js/out/browser/corecrypto.js`
- `crypto-ffi/bindings/js/out/browser/corecrypto.d.ts`
- `crypto-ffi/bindings/js/out/browser/autogenerated/wasm-bindgen/index_bg.wasm`

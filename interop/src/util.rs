...
use core_crypto_ffi::HistorySecret as HistorySecretFfi;
...
pub(crate) async fn cp_wasm_files(wasm_deploy_path: PathBuf) -> Result<()> {
    ...
    std::fs::copy(
        cwd.join("interop/src/html/index.html"),
        wasm_deploy_path.join("index.html"),
    )?;

    std::fs::copy(
        cwd.join("crypto-ffi/bindings/js/packages/core-crypto/dist/browser/corecrypto.js"),
    ...
    std::fs::create_dir(wasm_deploy_path.join("autogenerated/wasm-bindgen"))?;
    std::fs::copy(
        cwd.join("crypto-ffi/bindings/js/packages/core-crypto/dist/browser/autogenerated/wasm-bindgen/index_bg.wasm"),
        wasm_deploy_path.join("autogenerated/wasm-bindgen/index_bg.wasm"),
    )?;

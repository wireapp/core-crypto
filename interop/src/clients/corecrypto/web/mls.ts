...
export async function ccNew() {
    const { CoreCrypto, ClientId, Credential, CredentialType, Database, DatabaseKey, initWasmModule, ciphersuiteFromU16, MlsTransportResponse } = await import("./corecrypto.js");

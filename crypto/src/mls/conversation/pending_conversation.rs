...
mod tests {
    ...
    async fn should_buffer_and_reapply_messages_after_external_commit_merged(case: TestContext) {
        ...
        Box::pin(async move {
            ...
            let proposal_guard = conversation.external_join_proposal_guarded(&debbie).await;
    ...
    async fn should_not_reapply_buffered_messages_when_rejoining(case: TestContext) {
        ...
        Box::pin(async move {
            ...
            let conversation = conversation.acting_as(&bob).await.external_join(&alice).await;

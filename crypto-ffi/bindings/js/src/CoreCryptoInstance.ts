...
export {
    ...
    WireIdentity,
    X509Identity,
} from "./autogenerated/core-crypto-ffi.d";
...
export function setLogger(logger: CoreCryptoLogger): void {
    set_logger(loggerIntoFfi(logger));
}
...
export class CoreCrypto {
     ...
     */
    async addCredential(credential: CredentialRef): Promise<void> {
        return await CoreCryptoError.asyncMapErr(
            this.#cc.add_credential(credential)
        )
    }
}

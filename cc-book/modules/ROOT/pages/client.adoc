...
Opening the same database from two independent `CoreCrypto` instances — whether in the same process or different processes — is not supported and will produce undefined behavior.

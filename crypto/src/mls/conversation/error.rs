...
pub enum Error {
    ...
    #[error(
        "The tnt message counter has overflowed. You sent 2^32 targeted or transient messages in this epoch. Increment
        the epoch and try again."
    )]
    TntMessageCounterOverflow,

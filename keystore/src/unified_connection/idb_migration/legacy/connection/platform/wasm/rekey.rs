...
use crate::{
    ...
    traits::KeyType,
    unified_connection::idb_migration::legacy::traits::{Decryptable, Decrypting as _, Encrypting, Entity},
};
...
macro_rules! rekey_entities {
    ($db:expr, $old_cipher:expr, $new_cipher:expr, [$($entity:ty),*]) => {
        ...
        $(
            $crate::unified_connection::idb_migration::legacy::connection::platform::wasm::rekey::rekey_entity::<$entity>(

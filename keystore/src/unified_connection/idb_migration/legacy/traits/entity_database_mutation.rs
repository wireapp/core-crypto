...
use crate::{
    ...
    unified_connection::idb_migration::legacy::connection::KeystoreDatabaseConnection,
};
...
pub(crate) trait EntityDatabaseMutation<'a>: Entity<ConnectionType = KeystoreDatabaseConnection> {
    type Transaction: 'a;

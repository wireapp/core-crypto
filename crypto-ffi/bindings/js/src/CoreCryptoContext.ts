...
export class CoreCryptoContext {
     ...
     * @param credentialRef - ref to the credential the creator wants to create the group with
     * @param externalSender - Client ID that is qualified as external senders within the group
     */
    ...
    /**
     * Ingest an MLS welcome message to join an existing MLS group
     *
     * In case the orphan welcome message error occurs, ignore it and then join this group via
     * {@link CoreCryptoContext.joinByExternalCommit}.
     *
    ...
    async processWelcomeMessage(
        ...
        return await CoreCryptoError.asyncMapErr(
            this.#ctx.processWelcomeMessage(welcomeMessage)
        );
    }
     ...
     * @param credentialRef - Reference to the credential to use for joining this group.
     *

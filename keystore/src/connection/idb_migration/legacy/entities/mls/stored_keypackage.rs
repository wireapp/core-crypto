...
use crate::{
    ...
    migrations::LegacyStoredKeypackage,
    traits::{BorrowPrimaryKey, KeyType, PrimaryKey},
};

impl legacy::traits::EntityBase for LegacyStoredKeypackage {
...
impl legacy::traits::Entity for LegacyStoredKeypackage {
    #[allow(
...
impl legacy::traits::EntityGetBorrowed for LegacyStoredKeypackage {
    #[allow(
        elided_named_lifetimes,
        clippy::async_yields_async,
        clippy::diverging_sub_expression,
...
impl<'a> legacy::traits::EntityDatabaseMutation<'a> for LegacyStoredKeypackage {
...
impl<'a> legacy::traits::EntityDeleteBorrowed<'a> for LegacyStoredKeypackage {
    #[allow(
        elided_named_lifetimes,
        clippy::async_yields_async,
        clippy::diverging_sub_expression,
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for StoredKeypackageDecrypt {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                ...
                {
                    match __value {
                        "keypackage_ref" => _serde::__private228::Ok(__Field::__field0),
                        "keypackage" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
                ...
                {
                    match __value {
                        b"keypackage_ref" => _serde::__private228::Ok(__Field::__field0),
                        b"keypackage" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<StoredKeypackageDecrypt>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = StoredKeypackageDecrypt;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    _serde::__private228::Formatter::write_str(__formatter, "struct StoredKeypackageDecrypt")
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<Vec<u8>>(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(_serde::de::Error::invalid_length(
                                0usize,
                                &"struct StoredKeypackageDecrypt with 2 elements",
                            ));
                        }
                    };
                    ...
                    _serde::__private228::Ok(StoredKeypackageDecrypt {
                        keypackage_ref: __field0,
                        keypackage: __field1,
                    })
                }
                #[inline]
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                        ...
                        match __key {
                            __Field::__field0 => {
                                if _serde::__private228::Option::is_some(&__field0) {
                                    return _serde::__private228::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("keypackage_ref"),
                                    );
                                }
                            ...
                            __Field::__field1 => {
                                if _serde::__private228::Option::is_some(&__field1) {
                                    return _serde::__private228::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("keypackage"),
                                    );
                                }
                    ...
                    let __field0 = match __field0 {
                        ...
                        _serde::__private228::None => _serde::__private228::de::missing_field("keypackage_ref")?,
                    };
                    let __field1 = match __field1 {
                        _serde::__private228::Some(__field1) => __field1,
                        _serde::__private228::None => _serde::__private228::de::missing_field("keypackage")?,
                    };
                    _serde::__private228::Ok(StoredKeypackageDecrypt {
                        keypackage_ref: __field0,
                        keypackage: __field1,
            ...
            #[doc(hidden)]
            const FIELDS: &[&str] = &["keypackage_ref", "keypackage"];
...
impl legacy::traits::Decrypting<'static> for StoredKeypackageDecrypt {
    type DecryptedForm = LegacyStoredKeypackage;
    fn decrypt(self, cipher: &aes_gcm::Aes256Gcm) -> crate::CryptoKeystoreResult<LegacyStoredKeypackage> {
        Ok(LegacyStoredKeypackage {
            keypackage: <LegacyStoredKeypackage as legacy::traits::DecryptData>::decrypt_data(
                cipher,
                &self.keypackage_ref,
                &self.keypackage,
            )?,
...
impl legacy::traits::Decryptable<'static> for LegacyStoredKeypackage {
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'a> _serde::Serialize for StoredKeypackageEncrypt<'a> {
        fn serialize<__S>(&self, __serializer: __S) -> _serde::__private228::Result<__S::Ok, __S::Error>
        where
            __S: _serde::Serializer,
        {
            let mut __serde_state =
                _serde::Serializer::serialize_struct(__serializer, "StoredKeypackageEncrypt", false as usize + 1 + 1)?;
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "keypackage_ref", &self.keypackage_ref)?;
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "keypackage", &self.keypackage)?;
            _serde::ser::SerializeStruct::end(__serde_state)
        }
    }
};
impl<'a> legacy::traits::Encrypting<'a> for LegacyStoredKeypackage {
...
impl PrimaryKey for LegacyStoredKeypackage {
...
impl BorrowPrimaryKey for LegacyStoredKeypackage {

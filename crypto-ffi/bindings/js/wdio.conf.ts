...
if (process.env["WDIO_WORKER_ID"] === undefined) {
    ...
    await fs.mkdir(path.join(staticPath, "autogenerated"));
    await fs.mkdir(path.join(staticPath, "autogenerated", "wasm-bindgen"));
...
export const config: WebdriverIO.Config = {
    ...
    async onPrepare() {
        ...
        await copyFile(path.join(dir, "out", "corecrypto.js"), staticPath);
        await copyFile(
            path.join(dir, "out", "autogenerated","wasm-bindgen", "index_bg.wasm"),
            path.join(staticPath, "autogenerated","wasm-bindgen")
        );

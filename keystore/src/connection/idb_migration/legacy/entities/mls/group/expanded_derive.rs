...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for LegacyPersistedMlsGroupDecrypt {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<LegacyPersistedMlsGroupDecrypt>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = LegacyPersistedMlsGroupDecrypt;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    _serde::__private228::Formatter::write_str(__formatter, "struct LegacyPersistedMlsGroupDecrypt")
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<Vec<u8>>(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(_serde::de::Error::invalid_length(
                                0usize,
                                &"struct LegacyPersistedMlsGroupDecrypt with 3 elements",
                            ));
                        }
                    };
                    ...
                    _serde::__private228::Ok(LegacyPersistedMlsGroupDecrypt {
                        id: __field0,
                        parent_id: __field1,
                        state: __field2,
                    })
            ...
            _serde::Deserializer::deserialize_struct(
                __deserializer,
                "LegacyPersistedMlsGroupDecrypt",
                FIELDS,
                __Visitor {
                    marker: _serde::__private228::PhantomData::<LegacyPersistedMlsGroupDecrypt>,
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'a> _serde::Serialize for LegacyPersistedMlsGroupEncrypt<'a> {
            ...
            __S: _serde::Serializer,
        {
            let mut __serde_state = _serde::Serializer::serialize_struct(
                __serializer,
                "LegacyPersistedMlsGroupEncrypt",

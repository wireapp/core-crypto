...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for V33StoredEpochEncryptionKeypairDecrypt {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<V33StoredEpochEncryptionKeypairDecrypt>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = V33StoredEpochEncryptionKeypairDecrypt;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    _serde::__private228::Formatter::write_str(
                        __formatter,
                        "struct V33StoredEpochEncryptionKeypairDecrypt",
                    )
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<Vec<u8>>(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(_serde::de::Error::invalid_length(
                                0usize,
                                &"struct V33StoredEpochEncryptionKeypairDecrypt with 2 elements",
                            ));
                        }
                    };
                    ...
                    _serde::__private228::Ok(V33StoredEpochEncryptionKeypairDecrypt {
                        id: __field0,
                        keypairs: __field1,
                    })
                }
            ...
            _serde::Deserializer::deserialize_struct(
                __deserializer,
                "V33StoredEpochEncryptionKeypairDecrypt",
                FIELDS,
                __Visitor {
                    marker: _serde::__private228::PhantomData::<V33StoredEpochEncryptionKeypairDecrypt>,
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'a> _serde::Serialize for V33StoredEpochEncryptionKeypairEncrypt<'a> {
            ...
            __S: _serde::Serializer,
        {
            let mut __serde_state = _serde::Serializer::serialize_struct(
                __serializer,
                "V33StoredEpochEncryptionKeypairEncrypt",
                false as usize + 1 + 1,
            )?;

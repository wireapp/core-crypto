...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_CoreCrypto_4652_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_CoreCrypto_4652_rustbuffer_free(self, $0) }
    }
}
...
public func initWithPathAndKey( path: String,  key: String,  clientId: String ) throws -> CoreCrypto {
    ...
    CoreCrypto_4652_init_with_path_and_key(path.lower(), key.lower(), clientId.lower() , $0)
}
...
public protocol CoreCryptoProtocol {
    ...
    func clientPruneKeypackages( refs: [[UInt8]] ) throws
...
public class CoreCrypto: CoreCryptoProtocol {
    ...
    CoreCrypto_4652_CoreCrypto_new(path.lower(), key.lower(), clientId.lower() , $0)
})
    }

    deinit {
        try! rustCall { ffi_CoreCrypto_4652_CoreCrypto_object_free(pointer, $0) }
    }
    ...
    CoreCrypto_4652_CoreCrypto_set_callbacks(self.pointer, ffiConverterCallbackInterfaceCoreCryptoCallbacks.lower(callbacks) , $0
    )
}
    }
    ...
    CoreCrypto_4652_CoreCrypto_client_public_key(self.pointer,  $0
    )
}
    ...
    CoreCrypto_4652_CoreCrypto_client_keypackages(self.pointer, amountRequested.lower() , $0
    )
}
        return try FfiConverterSequenceSequenceUInt8.lift(_retval)
    }
    public func clientPruneKeypackages( refs: [[UInt8]] ) throws {
        try
    rustCallWithError(CryptoError.self) {
    
    CoreCrypto_4652_CoreCrypto_client_prune_keypackages(self.pointer, FfiConverterSequenceSequenceUInt8.lower(refs) , $0
    )
}
    }
    ...
    CoreCrypto_4652_CoreCrypto_create_conversation(self.pointer, FfiConverterTypeConversationId.lower(conversationId), config.lower() , $0
    )
}
    ...
    CoreCrypto_4652_CoreCrypto_conversation_exists(self.pointer, FfiConverterTypeConversationId.lower(conversationId) , $0
    )
}
    ...
    CoreCrypto_4652_CoreCrypto_process_welcome_message(self.pointer, FfiConverterSequenceUInt8.lower(welcomeMessage), config.lower() , $0
    )
}
    ...
    CoreCrypto_4652_CoreCrypto_add_clients_to_conversation(self.pointer, FfiConverterTypeConversationId.lower(conversationId), FfiConverterSequenceRecordInvitee.lower(clients) , $0
    )
}
        return try FfiConverterOptionRecordMemberAddedMessages.lift(_retval)
    }
    ...
    CoreCrypto_4652_CoreCrypto_remove_clients_from_conversation(self.pointer, FfiConverterTypeConversationId.lower(conversationId), FfiConverterSequenceRecordInvitee.lower(clients) , $0
    )
}
    ...
    CoreCrypto_4652_CoreCrypto_decrypt_message(self.pointer, FfiConverterTypeConversationId.lower(conversationId), FfiConverterSequenceUInt8.lower(payload) , $0
    )
}
        return try FfiConverterOptionSequenceUInt8.lift(_retval)
    }
    ...
    CoreCrypto_4652_CoreCrypto_encrypt_message(self.pointer, FfiConverterTypeConversationId.lower(conversationId), FfiConverterSequenceUInt8.lower(message) , $0
    )
}
        return try FfiConverterSequenceUInt8.lift(_retval)
    }
    ...
    CoreCrypto_4652_CoreCrypto_new_add_proposal(self.pointer, FfiConverterTypeConversationId.lower(conversationId), FfiConverterSequenceUInt8.lower(keyPackage) , $0
    )
}
        return try FfiConverterSequenceUInt8.lift(_retval)
    }
    ...
    CoreCrypto_4652_CoreCrypto_new_update_proposal(self.pointer, FfiConverterTypeConversationId.lower(conversationId) , $0
    )
}
        return try FfiConverterSequenceUInt8.lift(_retval)
    }
    ...
    CoreCrypto_4652_CoreCrypto_new_remove_proposal(self.pointer, FfiConverterTypeConversationId.lower(conversationId), FfiConverterTypeClientId.lower(clientId) , $0
    )
}
        return try FfiConverterSequenceUInt8.lift(_retval)
    }
...
extension CryptoError: ViaFfiUsingByteBuffer, ViaFfi {
    fileprivate static func read(from buf: Reader) throws -> CryptoError {
        ...
        case 9: return .CentralConfigurationError(
            message: try String.read(from: buf)
        )
...
private let ffiConverterCallbackInterfaceCoreCryptoCallbacks: FfiConverterCallbackInterface<CoreCryptoCallbacks> = {
    try! rustCall { (err: UnsafeMutablePointer<RustCallStatus>) in
            ffi_CoreCrypto_4652_CoreCryptoCallbacks_init_callback(foreignCallbackCallbackInterfaceCoreCryptoCallbacks, err)
    }

//! Uniffi uses the internal error directly. Wasm needs to wrap it in order to get proper error handling.
//! This module enables the appropriate type to show up where needed.

use super::internal::InternalError;

#[cfg(not(target_family = "wasm"))]
pub type CoreCryptoError = InternalError;

...
import * as CoreCryptoFfiTypes from "./autogenerated/core-crypto-ffi.d";
...
export class CoreCryptoContext {
   ...
   */
  async isHistorySharingEnabled(conversationId: ConversationId): Promise<boolean> {
    return await CoreCryptoError.asyncMapErr(this.#ctx.is_history_sharing_enabled(conversationId));
  }

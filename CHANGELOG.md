...
- Add a test case mimicing a real life bug ([WPB-15810]), demonstrating that in some cases it was possible to generate errors by swapping the ordering of two messages.
- Add a new layer of buffering to handle that situation.
  ...
  >
  > Clients do not need to take any action in response to this message. This error simply indicatest that the commit has been buffered, and will be automatically unbuffered when possible.

...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_ccd2_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_ccd2_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_CoreCrypto_ccd2_CoreCrypto_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_new(`path`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,`entropySeed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_ccd2_CoreCrypto_deferred_init(`path`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,`entropySeed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_ccd2_CoreCrypto_mls_init(`ptr`: Pointer,`clientId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_set_callbacks(`ptr`: Pointer,`callbacks`: Long,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_client_public_key(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_client_keypackages(`ptr`: Pointer,`amountRequested`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_client_valid_keypackages_count(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun CoreCrypto_ccd2_CoreCrypto_create_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`config`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_conversation_epoch(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun CoreCrypto_ccd2_CoreCrypto_conversation_exists(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun CoreCrypto_ccd2_CoreCrypto_process_welcome_message(`ptr`: Pointer,`welcomeMessage`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_add_clients_to_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clients`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_remove_clients_from_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clients`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_update_keying_material(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_commit_pending_proposals(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_wipe_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_decrypt_message(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`payload`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_encrypt_message(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`message`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_new_add_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`keyPackage`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_new_update_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_new_remove_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_new_external_add_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`epoch`: Long,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_new_external_remove_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`epoch`: Long,`keyPackageRef`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_join_by_external_commit(`ptr`: Pointer,`publicGroupState`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_export_group_state(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_merge_pending_group_from_external_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`config`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_clear_pending_group_from_external_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_export_secret_key(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`keyLength`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_get_client_ids(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_random_bytes(`ptr`: Pointer,`length`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_reseed_rng(`ptr`: Pointer,`seed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_commit_accepted(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_clear_pending_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`proposalRef`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_clear_pending_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_proteus_init(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_proteus_session_from_prekey(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`prekey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_proteus_session_from_message(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`envelope`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_session_save(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_proteus_session_delete(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_CoreCrypto_proteus_session_exists(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun CoreCrypto_ccd2_CoreCrypto_proteus_decrypt(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`ciphertext`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_encrypt(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`plaintext`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_encrypt_batched(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`plaintext`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_new_prekey(`ptr`: Pointer,`prekeyId`: Short,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_fingerprint(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_fingerprint_local(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_fingerprint_remote(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_ccd2_CoreCrypto_proteus_cryptobox_migrate(`ptr`: Pointer,`path`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_CoreCrypto_ccd2_CoreCryptoCallbacks_init_callback(`callbackStub`: ForeignCallback,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_ccd2_version(
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_ccd2_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_ccd2_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_ccd2_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_CoreCrypto_ccd2_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
class CoreCrypto(
    ...
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_new(FfiConverterString.lower(`path`), FfiConverterString.lower(`key`), FfiConverterString.lower(`clientId`), FfiConverterOptionalSequenceUByte.lower(`entropySeed`), _status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_ccd2_CoreCrypto_object_free(this.pointer, status)
        }
    }
    ...
    @Throws(CryptoException::class)override fun `mlsInit`(`clientId`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_mls_init(it, FfiConverterString.lower(`clientId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `setCallbacks`(`callbacks`: CoreCryptoCallbacks) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_set_callbacks(it, FfiConverterTypeCoreCryptoCallbacks.lower(`callbacks`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clientPublicKey`(): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_client_public_key(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `clientKeypackages`(`amountRequested`: UInt): List<List<UByte>> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_client_keypackages(it, FfiConverterUInt.lower(`amountRequested`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `clientValidKeypackagesCount`(): ULong =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_client_valid_keypackages_count(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `createConversation`(`conversationId`: ConversationId, `config`: ConversationConfiguration) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_create_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeConversationConfiguration.lower(`config`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `conversationEpoch`(`conversationId`: ConversationId): ULong =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_conversation_epoch(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterULong.lift(it)
        }
    override fun `conversationExists`(`conversationId`: ConversationId): Boolean =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_conversation_exists(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `processWelcomeMessage`(`welcomeMessage`: List<UByte>): ConversationId =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_process_welcome_message(it, FfiConverterSequenceUByte.lower(`welcomeMessage`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `addClientsToConversation`(`conversationId`: ConversationId, `clients`: List<Invitee>): MemberAddedMessages =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_add_clients_to_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceTypeInvitee.lower(`clients`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `removeClientsFromConversation`(`conversationId`: ConversationId, `clients`: List<ClientId>): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_remove_clients_from_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceTypeClientId.lower(`clients`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `updateKeyingMaterial`(`conversationId`: ConversationId): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_update_keying_material(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterTypeCommitBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `commitPendingProposals`(`conversationId`: ConversationId): CommitBundle? =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_commit_pending_proposals(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `wipeConversation`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_wipe_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `decryptMessage`(`conversationId`: ConversationId, `payload`: List<UByte>): DecryptedMessage =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_decrypt_message(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`payload`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `encryptMessage`(`conversationId`: ConversationId, `message`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_encrypt_message(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`message`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newAddProposal`(`conversationId`: ConversationId, `keyPackage`: List<UByte>): ProposalBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_new_add_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`keyPackage`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `newUpdateProposal`(`conversationId`: ConversationId): ProposalBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_new_update_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterTypeProposalBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newRemoveProposal`(`conversationId`: ConversationId, `clientId`: ClientId): ProposalBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_new_remove_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeClientId.lower(`clientId`),  _status)
}
        }.let {
            FfiConverterTypeProposalBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newExternalAddProposal`(`conversationId`: ConversationId, `epoch`: ULong): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_new_external_add_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterULong.lower(`epoch`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newExternalRemoveProposal`(`conversationId`: ConversationId, `epoch`: ULong, `keyPackageRef`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_new_external_remove_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterULong.lower(`epoch`), FfiConverterSequenceUByte.lower(`keyPackageRef`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `joinByExternalCommit`(`publicGroupState`: List<UByte>): ConversationInitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_join_by_external_commit(it, FfiConverterSequenceUByte.lower(`publicGroupState`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `exportGroupState`(`conversationId`: ConversationId): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_export_group_state(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `mergePendingGroupFromExternalCommit`(`conversationId`: ConversationId, `config`: ConversationConfiguration) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_merge_pending_group_from_external_commit(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeConversationConfiguration.lower(`config`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clearPendingGroupFromExternalCommit`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_clear_pending_group_from_external_commit(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `exportSecretKey`(`conversationId`: ConversationId, `keyLength`: UInt): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_export_secret_key(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterUInt.lower(`keyLength`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `getClientIds`(`conversationId`: ConversationId): List<ClientId> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_get_client_ids(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `randomBytes`(`length`: UInt): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_random_bytes(it, FfiConverterUInt.lower(`length`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `reseedRng`(`seed`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_reseed_rng(it, FfiConverterSequenceUByte.lower(`seed`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `commitAccepted`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_commit_accepted(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clearPendingProposal`(`conversationId`: ConversationId, `proposalRef`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_clear_pending_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`proposalRef`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clearPendingCommit`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_clear_pending_commit(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusInit`() =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_init(it,  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionFromPrekey`(`sessionId`: String, `prekey`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_session_from_prekey(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`prekey`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionFromMessage`(`sessionId`: String, `envelope`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_session_from_message(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`envelope`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionSave`(`sessionId`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_session_save(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionDelete`(`sessionId`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_session_delete(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionExists`(`sessionId`: String): Boolean =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_session_exists(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusDecrypt`(`sessionId`: String, `ciphertext`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_decrypt(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`ciphertext`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusEncrypt`(`sessionId`: String, `plaintext`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_encrypt(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`plaintext`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusEncryptBatched`(`sessionId`: List<String>, `plaintext`: List<UByte>): Map<String, List<UByte>> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_encrypt_batched(it, FfiConverterSequenceString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`plaintext`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `proteusNewPrekey`(`prekeyId`: UShort): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_new_prekey(it, FfiConverterUShort.lower(`prekeyId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprint`(): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_fingerprint(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprintLocal`(`sessionId`: String): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_fingerprint_local(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprintRemote`(`sessionId`: String): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_fingerprint_remote(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusCryptoboxMigrate`(`path`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_proteus_cryptobox_migrate(it, FfiConverterString.lower(`path`),  _status)
}
        }
    ...
    companion object {
        fun `deferredInit`(`path`: String, `key`: String, `entropySeed`: List<UByte>?): CoreCrypto =
            CoreCrypto(
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_CoreCrypto_deferred_init(FfiConverterString.lower(`path`), FfiConverterString.lower(`key`), FfiConverterOptionalSequenceUByte.lower(`entropySeed`), _status)
})
...
public object FfiConverterTypeCoreCryptoCallbacks: FfiConverterCallbackInterface<CoreCryptoCallbacks>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_CoreCrypto_ccd2_CoreCryptoCallbacks_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `version`(): String {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_ccd2_version( _status)
})
}

...
internal class E2EITest {
    ...
    fun `conversation should be not verified when at least 1 of the members uses a Basic credential`() = runTest {
        ...
        assertThat(alice.e2eiConversationState(welcomeBundle.id)).isEqualTo(E2eiConversationState.NOT_ENABLED)
        assertThat(bob.e2eiConversationState(welcomeBundle.id)).isEqualTo(E2eiConversationState.NOT_ENABLED)
    }

...
use crate::{
    entities::StoredE2eiEnrollment,
    traits::{BorrowPrimaryKey, KeyType},
    unified_connection::idb_migration::legacy,
};

impl legacy::traits::EntityBase for StoredE2eiEnrollment {
    ...
    fn to_transaction_entity(self) -> crate::transaction::dynamic_dispatch::Entity {
        crate::transaction::dynamic_dispatch::Entity::StoredE2eiEnrollment(self.into())
    }
}
impl legacy::traits::Entity for StoredE2eiEnrollment {
    #[allow(
...
impl legacy::traits::EntityGetBorrowed for StoredE2eiEnrollment {
    #[allow(
        elided_named_lifetimes,
        clippy::async_yields_async,
        clippy::diverging_sub_expression,
...
impl<'a> legacy::traits::EntityDatabaseMutation<'a> for StoredE2eiEnrollment {
...
impl<'a> legacy::traits::EntityDeleteBorrowed<'a> for StoredE2eiEnrollment {
    #[allow(
        elided_named_lifetimes,
        clippy::async_yields_async,
        clippy::diverging_sub_expression,
...
pub(crate) struct StoredE2eiEnrollmentDecrypt {
    id: Vec<u8>,
    content: Vec<u8>,
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for StoredE2eiEnrollmentDecrypt {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "content" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"content" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<StoredE2eiEnrollmentDecrypt>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = StoredE2eiEnrollmentDecrypt;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    _serde::__private228::Formatter::write_str(__formatter, "struct StoredE2eiEnrollmentDecrypt")
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<Vec<u8>>(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(_serde::de::Error::invalid_length(
                                0usize,
                                &"struct StoredE2eiEnrollmentDecrypt with 2 elements",
                            ));
                        }
                    };
                    ...
                    _serde::__private228::Ok(StoredE2eiEnrollmentDecrypt {
                        id: __field0,
                        content: __field1,
                    })
                }
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                        ...
                        match __key {
                            ...
                            __Field::__field1 => {
                                if _serde::__private228::Option::is_some(&__field1) {
                                    return _serde::__private228::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("content"),
                                    );
                                }
                    ...
                    let __field1 = match __field1 {
                        ...
                        _serde::__private228::None => _serde::__private228::de::missing_field("content")?,
                    };
                    _serde::__private228::Ok(StoredE2eiEnrollmentDecrypt {
                        id: __field0,
                        content: __field1,
...
impl legacy::traits::Decrypting<'static> for StoredE2eiEnrollmentDecrypt {
    type DecryptedForm = StoredE2eiEnrollment;
    fn decrypt(self, cipher: &aes_gcm::Aes256Gcm) -> crate::CryptoKeystoreResult<StoredE2eiEnrollment> {
        Ok(StoredE2eiEnrollment {
            content: <StoredE2eiEnrollment as legacy::traits::DecryptData>::decrypt_data(
                cipher,
                &self.id,
                &self.content,
            )?,
...
impl legacy::traits::Decryptable<'static> for StoredE2eiEnrollment {
    type DecryptableFrom = StoredE2eiEnrollmentDecrypt;
}
pub(crate) struct StoredE2eiEnrollmentEncrypt<'a> {
    id: &'a [u8],
    content: Vec<u8>,
}
#[doc(hidden)]
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'a> _serde::Serialize for StoredE2eiEnrollmentEncrypt<'a> {
            ...
            __S: _serde::Serializer,
        {
            ...
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "content", &self.content)?;
            _serde::ser::SerializeStruct::end(__serde_state)
        }
    }
};
impl<'a> legacy::traits::Encrypting<'a> for StoredE2eiEnrollment {
    type EncryptedForm = StoredE2eiEnrollmentEncrypt<'a>;
    fn encrypt(&'a self, cipher: &aes_gcm::Aes256Gcm) -> crate::CryptoKeystoreResult<StoredE2eiEnrollmentEncrypt<'a>> {
        Ok(StoredE2eiEnrollmentEncrypt {
            id: &self.id,

...
use crate::keystore_v_1_0_0::{CryptoKeystoreError, CryptoKeystoreResult};
use zeroize::Zeroize;
...
impl ProteusPrekey {
    ...
    pub async fn get_free_id(conn: &crate::keystore_v_1_0_0::Connection) -> CryptoKeystoreResult<u16> {
        let mut id = 1u16;
        let limit = u16::MAX;
        while id <= limit {
            if id == limit {
                return Err(CryptoKeystoreError::NoFreePrekeyId);
            }

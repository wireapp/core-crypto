...
export async function ccNew() {
    const { CoreCrypto, ClientId, Credential, CredentialType, DatabaseKey, initWasmModule, openDatabase, ciphersuiteFromU16, MlsTransportResponse } = await import("./corecrypto.js");

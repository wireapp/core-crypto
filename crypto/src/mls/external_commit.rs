...
mod tests {
    ...
    use crate::prelude::{MlsConversationConfiguration, WelcomeBundle};
        ...
        run_test_with_client_ids(
            ...
            move |[alice_central, mut bob_central]| {
                Box::pin(async move {
                    ...
                    let WelcomeBundle { id: group_id, .. } = bob_central
                        .context
    ...
    async fn join_by_external_commit_should_be_retriable(case: TestCase) {
        run_test_with_client_ids(case.clone(), ["alice", "bob"], move |[alice_central, bob_central]| {
            Box::pin(async move {
                ...
                let external_commit = success_provider.latest_commit().await;

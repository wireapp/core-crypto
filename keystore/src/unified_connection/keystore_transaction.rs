...
use crate::{
    ...
    traits::{BorrowPrimaryKey, UnifiedEntity, UnifiedEntityDatabaseMutation, UnifiedEntityDeleteBorrowed},
...
impl Database {
    ...
    where
        E: UnifiedEntity + UnifiedEntityDatabaseMutation + Send + Sync,
    {
    ...
    where
        E: UnifiedEntity + UnifiedEntityDatabaseMutation,
    {
    ...
    where
        E: UnifiedEntity + UnifiedEntityDatabaseMutation + BorrowPrimaryKey + UnifiedEntityDeleteBorrowed,
    {

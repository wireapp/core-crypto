...
impl crate::traits::EntityDatabaseMutation for StoredPskBundle {
        ...
        &'a Tx: Into<Transactionlike<'a>>,
    {
        ...
        let mut stmt = conn.prepare_cached("INSERT INTO mls_psk_bundles (id_sha256, psk_id, psk) VALUES (?, ?, ?)")?;

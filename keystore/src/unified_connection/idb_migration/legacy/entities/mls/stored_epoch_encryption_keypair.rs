...
//! for `StoredEpochEncryptionKeypair`.
//!
...
impl legacy::traits::EntityGetBorrowed for StoredEpochEncryptionKeypair {
    #[allow(
        elided_named_lifetimes,
        clippy::async_yields_async,
        clippy::diverging_sub_expression,
...
impl<'a> legacy::traits::EntityDatabaseMutation<'a> for StoredEpochEncryptionKeypair {
...
impl<'a> legacy::traits::EntityDeleteBorrowed<'a> for StoredEpochEncryptionKeypair {
    #[allow(
        elided_named_lifetimes,
        clippy::async_yields_async,
        clippy::diverging_sub_expression,
...
pub(crate) struct StoredEpochEncryptionKeypairDecrypt {
    id: Vec<u8>,
    keypairs: Vec<u8>,
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for StoredEpochEncryptionKeypairDecrypt {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "keypairs" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"keypairs" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<StoredEpochEncryptionKeypairDecrypt>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = StoredEpochEncryptionKeypairDecrypt;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    _serde::__private228::Formatter::write_str(
                        __formatter,
                        "struct StoredEpochEncryptionKeypairDecrypt",
                    )
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<Vec<u8>>(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(_serde::de::Error::invalid_length(
                                0usize,
                                &"struct StoredEpochEncryptionKeypairDecrypt with 2 elements",
                            ));
                        }
                    };
                    ...
                    _serde::__private228::Ok(StoredEpochEncryptionKeypairDecrypt {
                        id: __field0,
                        keypairs: __field1,
                    })
                }
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                        ...
                        match __key {
                            ...
                            __Field::__field1 => {
                                if _serde::__private228::Option::is_some(&__field1) {
                                    return _serde::__private228::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("keypairs"),
                                    );
                                }
                    ...
                    let __field1 = match __field1 {
                        ...
                        _serde::__private228::None => _serde::__private228::de::missing_field("keypairs")?,
                    };
                    _serde::__private228::Ok(StoredEpochEncryptionKeypairDecrypt {
                        id: __field0,
                        keypairs: __field1,
...
impl legacy::traits::Decrypting<'static> for StoredEpochEncryptionKeypairDecrypt {
    type DecryptedForm = StoredEpochEncryptionKeypair;
    fn decrypt(self, cipher: &aes_gcm::Aes256Gcm) -> crate::CryptoKeystoreResult<StoredEpochEncryptionKeypair> {
        Ok(StoredEpochEncryptionKeypair {
            keypairs: <StoredEpochEncryptionKeypair as legacy::traits::DecryptData>::decrypt_data(
                cipher,
                &self.id,
                &self.keypairs,
            )?,
...
impl legacy::traits::Decryptable<'static> for StoredEpochEncryptionKeypair {
    type DecryptableFrom = StoredEpochEncryptionKeypairDecrypt;
}
pub(crate) struct StoredEpochEncryptionKeypairEncrypt<'a> {
    id: &'a [u8],
    keypairs: Vec<u8>,
}
#[doc(hidden)]
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'a> _serde::Serialize for StoredEpochEncryptionKeypairEncrypt<'a> {
            ...
            __S: _serde::Serializer,
        {
            ...
            _serde::ser::SerializeStruct::serialize_field(&mut __serde_state, "keypairs", &self.keypairs)?;
            _serde::ser::SerializeStruct::end(__serde_state)
        }
    }
};
impl<'a> legacy::traits::Encrypting<'a> for StoredEpochEncryptionKeypair {
    type EncryptedForm = StoredEpochEncryptionKeypairEncrypt<'a>;
    fn encrypt(
        &'a self,
        cipher: &aes_gcm::Aes256Gcm,
    ) -> crate::CryptoKeystoreResult<StoredEpochEncryptionKeypairEncrypt<'a>> {
        Ok(StoredEpochEncryptionKeypairEncrypt {
            id: &self.id,

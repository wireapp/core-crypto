...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for E2eiCrlDecrypt {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                ...
                {
                    match __value {
                        "distribution_point" => _serde::__private228::Ok(__Field::__field0),
                ...
                {
                    match __value {
                        b"distribution_point" => _serde::__private228::Ok(__Field::__field0),
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<E2eiCrlDecrypt>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = E2eiCrlDecrypt;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    _serde::__private228::Formatter::write_str(__formatter, "struct E2eiCrlDecrypt")
                }
                #[inline]
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    let __field0 = match _serde::de::SeqAccess::next_element::<String>(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(_serde::de::Error::invalid_length(
                                0usize,
                                &"struct E2eiCrlDecrypt with 2 elements",
                            ));
                        }
                    };
                    ...
                    _serde::__private228::Ok(E2eiCrlDecrypt {
                        distribution_point: __field0,
                        content: __field1,
                    })
                }
                #[inline]
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                            ...
                            __Field::__field0 => {
                                if _serde::__private228::Option::is_some(&__field0) {
                                    return _serde::__private228::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("distribution_point"),
                                    );
                                }
                    ...
                    let __field0 = match __field0 {
                        ...
                        _serde::__private228::None => _serde::__private228::de::missing_field("distribution_point")?,
                    };
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'a> _serde::Serialize for E2eiCrlEncrypt<'a> {
        fn serialize<__S>(&self, __serializer: __S) -> _serde::__private228::Result<__S::Ok, __S::Error>
        where
            __S: _serde::Serializer,
        {
            let mut __serde_state =
                _serde::Serializer::serialize_struct(__serializer, "E2eiCrlEncrypt", false as usize + 1 + 1)?;

...
use super::{Entity, EntityDatabaseMutation, KeyType};
...
pub(crate) trait SearchableEntity<SearchKey: KeyType>: Entity {
...
#[cfg_attr(target_os = "unknown", async_trait(?Send))]
#[cfg_attr(not(target_os = "unknown"), async_trait)]
pub(crate) trait DeletableBySearchKey<'a, SearchKey: KeyType>:

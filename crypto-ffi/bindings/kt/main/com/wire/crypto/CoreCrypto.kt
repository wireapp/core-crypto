...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_cc2a_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_cc2a_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_CoreCrypto_cc2a_CoreCrypto_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_new(`path`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,`ciphersuites`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_cc2a_CoreCrypto_deferred_init(`path`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,`ciphersuites`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_cc2a_CoreCrypto_mls_init(`ptr`: Pointer,`clientId`: RustBuffer.ByValue,`ciphersuites`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_mls_generate_keypairs(`ptr`: Pointer,`ciphersuites`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_mls_init_with_client_id(`ptr`: Pointer,`clientId`: RustBuffer.ByValue,`signaturePublicKeys`: RustBuffer.ByValue,`ciphersuites`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_restore_from_disk(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_set_callbacks(`ptr`: Pointer,`callbacks`: Long,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_client_public_key(`ptr`: Pointer,`ciphersuite`: Short,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_client_keypackages(`ptr`: Pointer,`ciphersuite`: Short,`amountRequested`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_client_valid_keypackages_count(`ptr`: Pointer,`ciphersuite`: Short,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun CoreCrypto_cc2a_CoreCrypto_create_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`creatorCredentialType`: RustBuffer.ByValue,`config`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_conversation_epoch(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun CoreCrypto_cc2a_CoreCrypto_conversation_exists(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun CoreCrypto_cc2a_CoreCrypto_process_welcome_message(`ptr`: Pointer,`welcomeMessage`: RustBuffer.ByValue,`customConfiguration`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_add_clients_to_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clients`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_remove_clients_from_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clients`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_mark_conversation_as_child_of(`ptr`: Pointer,`childId`: RustBuffer.ByValue,`parentId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_update_keying_material(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_commit_pending_proposals(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_wipe_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_decrypt_message(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`payload`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_encrypt_message(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`message`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_new_add_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`keyPackage`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_new_update_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_new_remove_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_new_external_add_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`epoch`: Long,`ciphersuite`: Short,`credentialType`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_new_external_remove_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`epoch`: Long,`leafIndex`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_join_by_external_commit(`ptr`: Pointer,`groupInfo`: RustBuffer.ByValue,`customConfiguration`: RustBuffer.ByValue,`credentialType`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_merge_pending_group_from_external_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_clear_pending_group_from_external_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_export_group_info(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_export_secret_key(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`keyLength`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_get_client_ids(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_random_bytes(`ptr`: Pointer,`length`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_reseed_rng(`ptr`: Pointer,`seed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_commit_accepted(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_clear_pending_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`proposalRef`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_clear_pending_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_proteus_init(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_proteus_session_from_prekey(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`prekey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_proteus_session_from_message(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`envelope`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_session_save(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_proteus_session_delete(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_proteus_session_exists(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun CoreCrypto_cc2a_CoreCrypto_proteus_decrypt(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`ciphertext`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_encrypt(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`plaintext`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_encrypt_batched(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,`plaintext`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_new_prekey(`ptr`: Pointer,`prekeyId`: Short,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_new_prekey_auto(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_last_resort_prekey(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_last_resort_prekey_id(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Short

    fun CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint_local(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint_remote(`ptr`: Pointer,`sessionId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint_prekeybundle(`ptr`: Pointer,`prekey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_proteus_cryptobox_migrate(`ptr`: Pointer,`path`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_proteus_last_error_code(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Int

    fun CoreCrypto_cc2a_CoreCrypto_e2ei_new_enrollment(`ptr`: Pointer,`clientId`: RustBuffer.ByValue,`displayName`: RustBuffer.ByValue,`handle`: RustBuffer.ByValue,`expiryDays`: Int,`ciphersuite`: Short,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_cc2a_CoreCrypto_e2ei_mls_init(`ptr`: Pointer,`enrollment`: Pointer,`certificateChain`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_CoreCrypto_e2ei_enrollment_stash(`ptr`: Pointer,`enrollment`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_CoreCrypto_e2ei_enrollment_stash_pop(`ptr`: Pointer,`handle`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_cc2a_CoreCrypto_e2ei_is_degraded(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun ffi_CoreCrypto_cc2a_WireE2eIdentity_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_WireE2eIdentity_directory_response(`ptr`: Pointer,`directory`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_account_request(`ptr`: Pointer,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_account_response(`ptr`: Pointer,`account`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_WireE2eIdentity_new_order_request(`ptr`: Pointer,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_order_response(`ptr`: Pointer,`order`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_authz_request(`ptr`: Pointer,`url`: RustBuffer.ByValue,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_authz_response(`ptr`: Pointer,`authz`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_create_dpop_token(`ptr`: Pointer,`expirySecs`: Int,`backendNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_dpop_challenge_request(`ptr`: Pointer,`accessToken`: RustBuffer.ByValue,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_oidc_challenge_request(`ptr`: Pointer,`idToken`: RustBuffer.ByValue,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_new_challenge_response(`ptr`: Pointer,`challenge`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_WireE2eIdentity_check_order_request(`ptr`: Pointer,`orderUrl`: RustBuffer.ByValue,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_check_order_response(`ptr`: Pointer,`order`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_finalize_request(`ptr`: Pointer,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_finalize_response(`ptr`: Pointer,`finalize`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_cc2a_WireE2eIdentity_certificate_request(`ptr`: Pointer,`previousNonce`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_cc2a_CoreCryptoCallbacks_init_callback(`callbackStub`: ForeignCallback,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_cc2a_version(
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_cc2a_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_cc2a_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_cc2a_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_CoreCrypto_cc2a_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
public interface CoreCryptoInterface {
    ...
    @Throws(CryptoException::class)
    fun `mlsGenerateKeypairs`(`ciphersuites`: List<CiphersuiteName>): List<ClientId>
    
    @Throws(CryptoException::class)
    fun `mlsInitWithClientId`(`clientId`: ClientId, `signaturePublicKeys`: List<ClientId>, `ciphersuites`: List<CiphersuiteName>)
    ...
    @Throws(CryptoException::class)
    fun `newExternalRemoveProposal`(`conversationId`: ConversationId, `epoch`: ULong, `leafIndex`: UInt): List<UByte>
...
class CoreCrypto(
    ...
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_new(FfiConverterString.lower(`path`), FfiConverterString.lower(`key`), FfiConverterTypeClientId.lower(`clientId`), FfiConverterTypeCiphersuites.lower(`ciphersuites`), _status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_cc2a_CoreCrypto_object_free(this.pointer, status)
        }
    }
    ...
    @Throws(CryptoException::class)override fun `mlsInit`(`clientId`: ClientId, `ciphersuites`: Ciphersuites) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_mls_init(it, FfiConverterTypeClientId.lower(`clientId`), FfiConverterTypeCiphersuites.lower(`ciphersuites`),  _status)
}
        }
    
    
    @Throws(CryptoException::class)override fun `mlsGenerateKeypairs`(`ciphersuites`: List<CiphersuiteName>): List<ClientId> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_mls_generate_keypairs(it, FfiConverterSequenceTypeCiphersuiteName.lower(`ciphersuites`),  _status)
}
        }.let {
            FfiConverterSequenceTypeClientId.lift(it)
        }
    
    @Throws(CryptoException::class)override fun `mlsInitWithClientId`(`clientId`: ClientId, `signaturePublicKeys`: List<ClientId>, `ciphersuites`: List<CiphersuiteName>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_mls_init_with_client_id(it, FfiConverterTypeClientId.lower(`clientId`), FfiConverterSequenceTypeClientId.lower(`signaturePublicKeys`), FfiConverterSequenceTypeCiphersuiteName.lower(`ciphersuites`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `restoreFromDisk`() =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_restore_from_disk(it,  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `setCallbacks`(`callbacks`: CoreCryptoCallbacks) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_set_callbacks(it, FfiConverterTypeCoreCryptoCallbacks.lower(`callbacks`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clientPublicKey`(`ciphersuite`: Ciphersuite): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_client_public_key(it, FfiConverterTypeCiphersuite.lower(`ciphersuite`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `clientKeypackages`(`ciphersuite`: Ciphersuite, `amountRequested`: UInt): List<List<UByte>> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_client_keypackages(it, FfiConverterTypeCiphersuite.lower(`ciphersuite`), FfiConverterUInt.lower(`amountRequested`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `clientValidKeypackagesCount`(`ciphersuite`: Ciphersuite): ULong =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_client_valid_keypackages_count(it, FfiConverterTypeCiphersuite.lower(`ciphersuite`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `createConversation`(`conversationId`: ConversationId, `creatorCredentialType`: MlsCredentialType, `config`: ConversationConfiguration) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_create_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeMlsCredentialType.lower(`creatorCredentialType`), FfiConverterTypeConversationConfiguration.lower(`config`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `conversationEpoch`(`conversationId`: ConversationId): ULong =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_conversation_epoch(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterULong.lift(it)
        }
    override fun `conversationExists`(`conversationId`: ConversationId): Boolean =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_conversation_exists(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `processWelcomeMessage`(`welcomeMessage`: List<UByte>, `customConfiguration`: CustomConfiguration): ConversationId =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_process_welcome_message(it, FfiConverterSequenceUByte.lower(`welcomeMessage`), FfiConverterTypeCustomConfiguration.lower(`customConfiguration`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `addClientsToConversation`(`conversationId`: ConversationId, `clients`: List<Invitee>): MemberAddedMessages =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_add_clients_to_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceTypeInvitee.lower(`clients`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `removeClientsFromConversation`(`conversationId`: ConversationId, `clients`: List<ClientId>): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_remove_clients_from_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceTypeClientId.lower(`clients`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `markConversationAsChildOf`(`childId`: ConversationId, `parentId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_mark_conversation_as_child_of(it, FfiConverterTypeConversationId.lower(`childId`), FfiConverterTypeConversationId.lower(`parentId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `updateKeyingMaterial`(`conversationId`: ConversationId): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_update_keying_material(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterTypeCommitBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `commitPendingProposals`(`conversationId`: ConversationId): CommitBundle? =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_commit_pending_proposals(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `wipeConversation`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_wipe_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `decryptMessage`(`conversationId`: ConversationId, `payload`: List<UByte>): DecryptedMessage =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_decrypt_message(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`payload`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `encryptMessage`(`conversationId`: ConversationId, `message`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_encrypt_message(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`message`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newAddProposal`(`conversationId`: ConversationId, `keyPackage`: List<UByte>): ProposalBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_new_add_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`keyPackage`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `newUpdateProposal`(`conversationId`: ConversationId): ProposalBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_new_update_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterTypeProposalBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newRemoveProposal`(`conversationId`: ConversationId, `clientId`: ClientId): ProposalBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_new_remove_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeClientId.lower(`clientId`),  _status)
}
        }.let {
            FfiConverterTypeProposalBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newExternalAddProposal`(`conversationId`: ConversationId, `epoch`: ULong, `ciphersuite`: Ciphersuite, `credentialType`: MlsCredentialType): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_new_external_add_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterULong.lower(`epoch`), FfiConverterTypeCiphersuite.lower(`ciphersuite`), FfiConverterTypeMlsCredentialType.lower(`credentialType`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    
    @Throws(CryptoException::class)override fun `newExternalRemoveProposal`(`conversationId`: ConversationId, `epoch`: ULong, `leafIndex`: UInt): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_new_external_remove_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterULong.lower(`epoch`), FfiConverterUInt.lower(`leafIndex`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `joinByExternalCommit`(`groupInfo`: List<UByte>, `customConfiguration`: CustomConfiguration, `credentialType`: MlsCredentialType): ConversationInitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_join_by_external_commit(it, FfiConverterSequenceUByte.lower(`groupInfo`), FfiConverterTypeCustomConfiguration.lower(`customConfiguration`), FfiConverterTypeMlsCredentialType.lower(`credentialType`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `mergePendingGroupFromExternalCommit`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_merge_pending_group_from_external_commit(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clearPendingGroupFromExternalCommit`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_clear_pending_group_from_external_commit(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `exportGroupInfo`(`conversationId`: ConversationId): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_export_group_info(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `exportSecretKey`(`conversationId`: ConversationId, `keyLength`: UInt): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_export_secret_key(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterUInt.lower(`keyLength`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `getClientIds`(`conversationId`: ConversationId): List<ClientId> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_get_client_ids(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterSequenceTypeClientId.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `randomBytes`(`length`: UInt): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_random_bytes(it, FfiConverterUInt.lower(`length`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `reseedRng`(`seed`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_reseed_rng(it, FfiConverterSequenceUByte.lower(`seed`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `commitAccepted`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_commit_accepted(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clearPendingProposal`(`conversationId`: ConversationId, `proposalRef`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_clear_pending_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`proposalRef`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clearPendingCommit`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_clear_pending_commit(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusInit`() =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_init(it,  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionFromPrekey`(`sessionId`: String, `prekey`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_session_from_prekey(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`prekey`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionFromMessage`(`sessionId`: String, `envelope`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_session_from_message(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`envelope`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionSave`(`sessionId`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_session_save(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionDelete`(`sessionId`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_session_delete(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `proteusSessionExists`(`sessionId`: String): Boolean =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_session_exists(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusDecrypt`(`sessionId`: String, `ciphertext`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_decrypt(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`ciphertext`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusEncrypt`(`sessionId`: String, `plaintext`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_encrypt(it, FfiConverterString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`plaintext`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusEncryptBatched`(`sessionId`: List<String>, `plaintext`: List<UByte>): Map<String, List<UByte>> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_encrypt_batched(it, FfiConverterSequenceString.lower(`sessionId`), FfiConverterSequenceUByte.lower(`plaintext`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `proteusNewPrekey`(`prekeyId`: UShort): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_new_prekey(it, FfiConverterUShort.lower(`prekeyId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusNewPrekeyAuto`(): ProteusAutoPrekeyBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_new_prekey_auto(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `proteusLastResortPrekey`(): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_last_resort_prekey(it,  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusLastResortPrekeyId`(): UShort =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_last_resort_prekey_id(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprint`(): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprintLocal`(`sessionId`: String): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint_local(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprintRemote`(`sessionId`: String): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint_remote(it, FfiConverterString.lower(`sessionId`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusFingerprintPrekeybundle`(`prekey`: List<UByte>): String =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_fingerprint_prekeybundle(it, FfiConverterSequenceUByte.lower(`prekey`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `proteusCryptoboxMigrate`(`path`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_cryptobox_migrate(it, FfiConverterString.lower(`path`),  _status)
}
        }
    ...
    override fun `proteusLastErrorCode`(): UInt =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_proteus_last_error_code(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `e2eiNewEnrollment`(`clientId`: String, `displayName`: String, `handle`: String, `expiryDays`: UInt, `ciphersuite`: Ciphersuite): WireE2eIdentity =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_e2ei_new_enrollment(it, FfiConverterString.lower(`clientId`), FfiConverterString.lower(`displayName`), FfiConverterString.lower(`handle`), FfiConverterUInt.lower(`expiryDays`), FfiConverterTypeCiphersuite.lower(`ciphersuite`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `e2eiMlsInit`(`enrollment`: WireE2eIdentity, `certificateChain`: String) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_e2ei_mls_init(it, FfiConverterTypeWireE2eIdentity.lower(`enrollment`), FfiConverterString.lower(`certificateChain`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `e2eiEnrollmentStash`(`enrollment`: WireE2eIdentity): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_e2ei_enrollment_stash(it, FfiConverterTypeWireE2eIdentity.lower(`enrollment`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `e2eiEnrollmentStashPop`(`handle`: List<UByte>): WireE2eIdentity =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_e2ei_enrollment_stash_pop(it, FfiConverterSequenceUByte.lower(`handle`),  _status)
}
        }.let {
            FfiConverterTypeWireE2eIdentity.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `e2eiIsDegraded`(`conversationId`: ConversationId): Boolean =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_e2ei_is_degraded(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    companion object {
        fun `deferredInit`(`path`: String, `key`: String, `ciphersuites`: Ciphersuites): CoreCrypto =
            CoreCrypto(
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_CoreCrypto_deferred_init(FfiConverterString.lower(`path`), FfiConverterString.lower(`key`), FfiConverterTypeCiphersuites.lower(`ciphersuites`), _status)
})
...
class WireE2eIdentity(
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_cc2a_WireE2eIdentity_object_free(this.pointer, status)
        }
    }
    ...
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_directory_response(it, FfiConverterSequenceUByte.lower(`directory`),  _status)
}
        }.let {
    ...
    @Throws(E2eIdentityException::class)override fun `newAccountRequest`(`previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_account_request(it, FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newAccountResponse`(`account`: List<UByte>) =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_account_response(it, FfiConverterSequenceUByte.lower(`account`),  _status)
}
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newOrderRequest`(`previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_order_request(it, FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newOrderResponse`(`order`: List<UByte>): NewAcmeOrder =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_order_response(it, FfiConverterSequenceUByte.lower(`order`),  _status)
}
        }.let {
    ...
    @Throws(E2eIdentityException::class)override fun `newAuthzRequest`(`url`: String, `previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_authz_request(it, FfiConverterString.lower(`url`), FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newAuthzResponse`(`authz`: List<UByte>): NewAcmeAuthz =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_authz_response(it, FfiConverterSequenceUByte.lower(`authz`),  _status)
}
        }.let {
    ...
    @Throws(E2eIdentityException::class)override fun `createDpopToken`(`expirySecs`: UInt, `backendNonce`: String): String =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_create_dpop_token(it, FfiConverterUInt.lower(`expirySecs`), FfiConverterString.lower(`backendNonce`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newDpopChallengeRequest`(`accessToken`: String, `previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_dpop_challenge_request(it, FfiConverterString.lower(`accessToken`), FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newOidcChallengeRequest`(`idToken`: String, `previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_oidc_challenge_request(it, FfiConverterString.lower(`idToken`), FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `newChallengeResponse`(`challenge`: List<UByte>) =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_new_challenge_response(it, FfiConverterSequenceUByte.lower(`challenge`),  _status)
}
        }
    ...
    @Throws(E2eIdentityException::class)override fun `checkOrderRequest`(`orderUrl`: String, `previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_check_order_request(it, FfiConverterString.lower(`orderUrl`), FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `checkOrderResponse`(`order`: List<UByte>): String =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_check_order_response(it, FfiConverterSequenceUByte.lower(`order`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `finalizeRequest`(`previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_finalize_request(it, FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `finalizeResponse`(`finalize`: List<UByte>): String =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_finalize_response(it, FfiConverterSequenceUByte.lower(`finalize`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(E2eIdentityException::class)override fun `certificateRequest`(`previousNonce`: String): List<UByte> =
        callWithPointer {
    rustCallWithError(E2eIdentityException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_WireE2eIdentity_certificate_request(it, FfiConverterString.lower(`previousNonce`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
...
public object FfiConverterTypeCoreCryptoCallbacks: FfiConverterCallbackInterface<CoreCryptoCallbacks>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_CoreCrypto_cc2a_CoreCryptoCallbacks_init_callback(this.foreignCallback, status)
        }
    }
}
...
public object FfiConverterSequenceTypeCiphersuiteName: FfiConverterRustBuffer<List<CiphersuiteName>> {
    override fun read(buf: ByteBuffer): List<CiphersuiteName> {
        val len = buf.getInt()
        return List<CiphersuiteName>(len) {
            FfiConverterTypeCiphersuiteName.read(buf)
        }
    }

    override fun allocationSize(value: List<CiphersuiteName>): Int {
        val sizeForLength = 4
        val sizeForItems = value.map { FfiConverterTypeCiphersuiteName.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(value: List<CiphersuiteName>, buf: ByteBuffer) {
        buf.putInt(value.size)
        value.forEach {
            FfiConverterTypeCiphersuiteName.write(it, buf)
        }
    }
}
...
fun `version`(): String {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_cc2a_version( _status)
})
}

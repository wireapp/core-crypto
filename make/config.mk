...
NATIVE_CARGO_BUILD_ARGS := $(CARGO_BUILD_ARGS) --features cancellable-transactions
DARWIN_CARGO_BUILD_ARGS := $(CARGO_BUILD_ARGS) --features cancellable-transactions,cross-process-lock

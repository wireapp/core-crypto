...
impl EntityBase for E2eiIntermediateCert {
    ...
    async fn delete(conn: &mut Self::ConnectionType, ids: &[StringEntityId]) -> CryptoKeystoreResult<()> {
        ...
        storage.delete("e2ei_intermediate_certs", &ids).await
    }
}

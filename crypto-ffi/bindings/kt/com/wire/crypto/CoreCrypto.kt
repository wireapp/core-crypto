...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_406e_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_406e_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_CoreCrypto_406e_CoreCrypto_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_new(`path`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,`entropySeed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_406e_CoreCrypto_set_callbacks(`ptr`: Pointer,`callbacks`: Long,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_client_public_key(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_client_keypackages(`ptr`: Pointer,`amountRequested`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_client_valid_keypackages_count(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun CoreCrypto_406e_CoreCrypto_create_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`config`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_conversation_exists(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun CoreCrypto_406e_CoreCrypto_process_welcome_message(`ptr`: Pointer,`welcomeMessage`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_add_clients_to_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clients`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_remove_clients_from_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clients`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_wipe_conversation(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_decrypt_message(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`payload`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_encrypt_message(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`message`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_new_add_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`keyPackage`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_new_update_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_new_remove_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_new_external_add_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`epoch`: Long,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_new_external_remove_proposal(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`epoch`: Long,`keyPackageRef`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_update_keying_material(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_join_by_external_commit(`ptr`: Pointer,`groupState`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_export_group_state(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_merge_pending_group_from_external_commit(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,`config`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_random_bytes(`ptr`: Pointer,`length`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun CoreCrypto_406e_CoreCrypto_reseed_rng(`ptr`: Pointer,`seed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_commit_accepted(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_CoreCrypto_commit_pending_proposals(`ptr`: Pointer,`conversationId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_406e_CoreCryptoCallbacks_init_callback(`callbackStub`: ForeignCallback,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun CoreCrypto_406e_init_with_path_and_key(`path`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,`clientId`: RustBuffer.ByValue,`entropySeed`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun CoreCrypto_406e_version(
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_406e_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_406e_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_CoreCrypto_406e_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_CoreCrypto_406e_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
class CoreCrypto(
    ...
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_new(FfiConverterString.lower(`path`), FfiConverterString.lower(`key`), FfiConverterString.lower(`clientId`), FfiConverterOptionalSequenceUByte.lower(`entropySeed`), _status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_CoreCrypto_406e_CoreCrypto_object_free(this.pointer, status)
        }
    }
    ...
    @Throws(CryptoException::class)override fun `setCallbacks`(`callbacks`: CoreCryptoCallbacks) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_set_callbacks(it, FfiConverterTypeCoreCryptoCallbacks.lower(`callbacks`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `clientPublicKey`(): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_client_public_key(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `clientKeypackages`(`amountRequested`: UInt): List<List<UByte>> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_client_keypackages(it, FfiConverterUInt.lower(`amountRequested`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `clientValidKeypackagesCount`(): ULong =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_client_valid_keypackages_count(it,  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `createConversation`(`conversationId`: ConversationId, `config`: ConversationConfiguration) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_create_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeConversationConfiguration.lower(`config`),  _status)
}
        }
    ...
    override fun `conversationExists`(`conversationId`: ConversationId): Boolean =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_conversation_exists(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `processWelcomeMessage`(`welcomeMessage`: List<UByte>): ConversationId =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_process_welcome_message(it, FfiConverterSequenceUByte.lower(`welcomeMessage`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `addClientsToConversation`(`conversationId`: ConversationId, `clients`: List<Invitee>): MemberAddedMessages =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_add_clients_to_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceTypeInvitee.lower(`clients`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `removeClientsFromConversation`(`conversationId`: ConversationId, `clients`: List<ClientId>): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_remove_clients_from_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceTypeClientId.lower(`clients`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `wipeConversation`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_wipe_conversation(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `decryptMessage`(`conversationId`: ConversationId, `payload`: List<UByte>): DecryptedMessage =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_decrypt_message(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`payload`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `encryptMessage`(`conversationId`: ConversationId, `message`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_encrypt_message(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`message`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newAddProposal`(`conversationId`: ConversationId, `keyPackage`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_new_add_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterSequenceUByte.lower(`keyPackage`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newUpdateProposal`(`conversationId`: ConversationId): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_new_update_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newRemoveProposal`(`conversationId`: ConversationId, `clientId`: ClientId): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_new_remove_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeClientId.lower(`clientId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newExternalAddProposal`(`conversationId`: ConversationId, `epoch`: ULong): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_new_external_add_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterULong.lower(`epoch`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `newExternalRemoveProposal`(`conversationId`: ConversationId, `epoch`: ULong, `keyPackageRef`: List<UByte>): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_new_external_remove_proposal(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterULong.lower(`epoch`), FfiConverterSequenceUByte.lower(`keyPackageRef`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `updateKeyingMaterial`(`conversationId`: ConversationId): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_update_keying_material(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterTypeCommitBundle.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `joinByExternalCommit`(`groupState`: List<UByte>): MlsConversationInitMessage =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_join_by_external_commit(it, FfiConverterSequenceUByte.lower(`groupState`),  _status)
}
        }.let {
    ...
    @Throws(CryptoException::class)override fun `exportGroupState`(`conversationId`: ConversationId): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_export_group_state(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `mergePendingGroupFromExternalCommit`(`conversationId`: ConversationId, `config`: ConversationConfiguration) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_merge_pending_group_from_external_commit(it, FfiConverterTypeConversationId.lower(`conversationId`), FfiConverterTypeConversationConfiguration.lower(`config`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `randomBytes`(`length`: UInt): List<UByte> =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_random_bytes(it, FfiConverterUInt.lower(`length`),  _status)
}
        }.let {
            FfiConverterSequenceUByte.lift(it)
        }
    ...
    @Throws(CryptoException::class)override fun `reseedRng`(`seed`: List<UByte>) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_reseed_rng(it, FfiConverterSequenceUByte.lower(`seed`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `commitAccepted`(`conversationId`: ConversationId) =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_commit_accepted(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }
    ...
    @Throws(CryptoException::class)override fun `commitPendingProposals`(`conversationId`: ConversationId): CommitBundle =
        callWithPointer {
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_CoreCrypto_commit_pending_proposals(it, FfiConverterTypeConversationId.lower(`conversationId`),  _status)
}
        }.let {
            FfiConverterTypeCommitBundle.lift(it)
        }
...
public object FfiConverterTypeCryptoError : FfiConverterRustBuffer<CryptoException> {
    override fun read(buf: ByteBuffer): CryptoException {
            ...
            20 -> CryptoException.ExternalProposalException(FfiConverterString.read(buf))
            21 -> CryptoException.InvalidProposalType(FfiConverterString.read(buf))
...
public object FfiConverterTypeCoreCryptoCallbacks: FfiConverterCallbackInterface<CoreCryptoCallbacks>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_CoreCrypto_406e_CoreCryptoCallbacks_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `initWithPathAndKey`(`path`: String, `key`: String, `clientId`: String, `entropySeed`: List<UByte>?): CoreCrypto {
    ...
    rustCallWithError(CryptoException) { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_init_with_path_and_key(FfiConverterString.lower(`path`), FfiConverterString.lower(`key`), FfiConverterString.lower(`clientId`), FfiConverterOptionalSequenceUByte.lower(`entropySeed`), _status)
})
}
...
fun `version`(): String {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.CoreCrypto_406e_version( _status)
})
}
